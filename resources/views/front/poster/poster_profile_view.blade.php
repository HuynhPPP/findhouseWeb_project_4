...
@section('poster')
    ...
    <div class="col-lg-6 col-md-6 col-xs-6 widget-boxed mt-33 mt-0 offset-lg-2 offset-md-3 mt-4">
        ...
        <div class="sidebar-widget author-widget2">
            <form name="contact_form" method="post" action="{{ route('poster.store.profile') }}"
                ...
                <div class="author-box clearfix">
                    <img src="{{ !empty($profileData->photo) && str_starts_with($profileData->photo, 'poster_')
                        ...
                        alt="author-image" class="author__img" id="showImage">
                ...
                <ul class="author__contact">
                    <li><span class="la la-phone"><i class="fa fa-phone" aria-hidden="true"></i></span><a
                            href="#">(84) {{ $profileData->phone }}</a></li>
                    <li><span class="la la-envelope-o"><i class="fa fa-envelope" aria-hidden="true"></i></span><a
                            href="#">{{ $profileData->email }}</a></li>
                </ul>
                <div class="agent-contact-form-sidebar">
                    <h4>Cập nhật thông tin</h4>
                    <input type="text" id="fname" name="name" placeholder="Tên liên hệ"
                        value="{{ $profileData->name }}" />
                    <input type="number" id="pnumber" name="phone" placeholder="Số điện thoại"
