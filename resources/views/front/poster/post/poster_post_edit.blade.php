          ...
          <div class="row">
            ...
            <div class="single-add-property">
              ...
              <div class="video-link-container">
                ...
                <input type="text" id="videoLink" name="video_url"
                  class="form-control" placeholder="Dán link video vào đây..."
                  value="{{ $video_url_fixed ?? '' }}">
                <p class="text-muted">
                  📌 <strong>Lưu ý:</strong> Chỉ hỗ trợ YouTube & TikTok. Vui lòng
                  nhập đúng định dạng
                  sau:<br>
                  <br>
                  🔹 <strong>Đối với YouTube:</strong><br>
                  -
                  <code>https://www.youtube.com/watch?v=<b>xxxxxxxxxxx</b></code>
                  ✅<br>
                  - <code>https://youtu.be/<b>xxxxxxxxxxx</b></code> ✅<br>
                  <br>
                  🔹 <strong>Đối với TikTok:</strong><br>
                  -
                  <code>https://www.tiktok.com/@<b>username</b>/video/<b>xxxxxxxxxxx</b></code>
                  ✅<br>
                  <br>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-12">
              <p>
                ...
                <input type="text" placeholder="Nhập họ tên" id="con-name"
                  name="name_poster"
            ...
            <div class="col-lg-4 col-md-12">
              <p class="no-mb first">
                ...
                <input type="email" placeholder="Enter Your Email"
                  id="con-email" name="email_poster"
...
@section('customJs')
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function getEmbeddedVideo(url) {
        ...
        if (url.includes("youtube.com/watch?v=") || url.includes(
          "youtu.be/")) {
          let videoId = url.split("v=")[1]?.split("&")[0] || url.split(
            "youtu.be/")[1];
          if (videoId) {
            embedHtml =
        ...
        if (embedHtml) {
          ...
          if (url.includes("tiktok.com/")) {
            if (!window.tiktokEmbedLoaded) {
              ...
              window
            .tiktokEmbedLoad(); // Tải lại video TikTok nếu script đã có
            }
          }
        } else {
            ...
            $.ajax({
              ...
              success: function(data) {
                if (data.success) {
                  ...
                  Swal.fire("Đã xóa!", "Ảnh đã được xóa.",
                    "success");
                } else {
                  Swal.fire("Lỗi!", "Không thể xóa ảnh.",
                    "error");
                }
              },
              error: function() {
  ...
  <script>
    document.getElementById("rental_price").addEventListener("input",
      updatePriceInWords);
    document.getElementById("rental_unit").addEventListener("change",
      updatePriceInWords);

    function updatePriceInWords() {
      let amount = document.getElementById("rental_price").value.replace(/\./g,
        "").trim();
