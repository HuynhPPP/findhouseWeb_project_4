...
@section('home_2')
@section('title')
    Danh sách tin đăng ở khu vực {{ $province }}
@endsection
...
<section class="properties-list featured portfolio blog">
    <div class="container">
        ...
        <!-- Block heading end -->
        <div class="row featured portfolio-items" id="post-list-province">
            @include('front.main.sort_page.posts_list_sort_province', ['posts' => $posts])
        </div>
        <!-- Phân trang -->
...
<script>
    $(document).ready(function() {
        ...
        function loadPosts(sort, page) {
            ...
            $.ajax({
                url: '{{ route('posts.province.sort', $province) }}',
                type: 'GET',
                data: {
                    sort: sort,
                    page: page
                ...
                success: function(response) {
                    $('#post-list-province').html(response.posts_html);
